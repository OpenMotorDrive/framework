...
#include <stdint.h>
#include <modules/platform_stm32f429/platform_stm32f429.h>
...
#define BOARD_PAL_LINE_CAN_RX PAL_LINE(GPIOA,11U)
#define BOARD_PAL_LINE_CAN_TX PAL_LINE(GPIOA,12U)

#define BOARD_PAL_LINE_RED_LED PAL_LINE(GPIOG,14U)
#define BOARD_PAL_LINE_GREEN_LED PAL_LINE(GPIOG,13U)
